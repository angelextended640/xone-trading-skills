...
nav_order: 12
permalink: /vi/skills/breadth-chart-analyst/
---
...
[Download Skill Package (.skill)](https://github.com/xonevn-ai/xone-trading-skills/raw/main/skill-packages/breadth-chart-analyst.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[View Source on GitHub](https://github.com/xonevn-ai/xone-trading-skills/tree/main/skills/breadth-chart-analyst){: .btn .fs-5 .mb-4 .mb-md-0 }
...
**Data Sources**:
1. **Market Breadth**: `xonevn-ai.github.io/market-breadth-analysis/market_breadth_data.csv`
   - Provides: 200-Day MA, 8-Day MA, Trend, Dead Cross status
2. **Uptrend Ratio**: `xonevn-ai/uptrend-dashboard/data/uptrend_ratio_timeseries.csv`
   - Provides: Current ratio, 10MA, slope, trend (UP/DOWN), color (GREEN/RED)
3. **Sector Summary**: `xonevn-ai/uptrend-dashboard/data/sector_summary.csv`
