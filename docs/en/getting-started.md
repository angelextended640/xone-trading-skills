...
1. Download the `.skill` file (ZIP format) for the skill you want from the [`skill-packages/`](https://github.com/xonevn-ai/xone-trading-skills/tree/main/skill-packages) directory.
...
cp -r xone-trading-skills/skills/finviz-screener /path/to/skills-directory/
