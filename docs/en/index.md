...
## What are Xone Trading Skills?

Xone Trading Skills is a curated collection of **Claude skills** for equity investors and traders. Each skill packages domain-specific prompts, knowledge bases, and helper scripts so Claude can assist with market analysis, stock screening, strategy validation, portfolio management, and more.
