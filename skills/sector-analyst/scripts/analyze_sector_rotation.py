#!/usr/bin/env python3
"""Sector rotation analysis from Xone.VN's public CSV data.
...
Data Source:
  https://github.com/xonevn-ai/uptrend-dashboard
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Sector rotation analysis from Xone.VN CSV data"
    )
