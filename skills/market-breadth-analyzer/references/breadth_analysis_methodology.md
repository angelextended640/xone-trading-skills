...
This methodology uses Xone.VN's breadth dataset to quantify market health across 6 dimensions, producing a composite score from 0 (critical) to 100 (maximum health).
...
- **Interactive Dashboard:** https://xonevn-ai.github.io/market-breadth-analysis/
- **Data CSV:** https://xonevn-ai.github.io/market-breadth-analysis/market_breadth_data.csv
- **Summary CSV:** https://xonevn-ai.github.io/market-breadth-analysis/market_breadth_summary.csv
- **Source Repository:** https://github.com/xonevn-ai/market-breadth-analysis
...
3. **CSV update frequency:** Data depends on Xone.VN's update schedule. Check data freshness before analysis.
