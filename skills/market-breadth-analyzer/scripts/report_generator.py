...
def generate_markdown_report(analysis: dict, output_file: str):
    ...
    lines.append("**Data Source:** Xone.VN Market Breadth CSV (no API key required)")
    ...
    lines.append(
        ...
        "(https://xonevn-ai.github.io/market-breadth-analysis/)"
    )
    lines.append("")
    ...
    lines.append("")
    lines.append(
        "This analysis uses Xone.VN's market breadth dataset to quantify "
