...
description: Monitor dividend portfolios with Kanchi-style forced-review triggers (T1-T5) and convert anomalies into OK/WARN/REVIEW states without auto-selling. Use when users ask for dividend-cut detection, 8-K governance monitoring, dividend safety monitoring, REVIEW queue automation, or periodic dividend risk checks.
---
