#!/usr/bin/env python3
"""
Breadth CSV Client - Fetch 200DMA breadth from Xone.VN's public CSV.
...
Data source:
  https://xonevn-ai.github.io/market-breadth-analysis/market_breadth_data.csv
"""
...
def fetch_breadth_200dma(url: str = DEFAULT_DETAIL_URL) -> Optional[dict]:
    """
    Fetch the latest 200DMA breadth value from Xone.VN CSV.
