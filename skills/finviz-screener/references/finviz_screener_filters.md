...
|------|---------|---------------------------|
| `ta_topgainers` | Top Gainers | gainers |
| `ta_toplosers` | Top Losers | losers |
| `ta_newhigh` | New High | new high |
| `ta_newlow` | New Low | new low |
| `ta_mostvolatile` | Most Volatile | volatile |
| `ta_mostactive` | Most Active | active |
| `ta_unusualvolume` | Unusual Volume | unusual volume |
| `ta_overbought` | Overbought | overbought |
| `ta_oversold` | Oversold | oversold |
| `ta_downgrades` | Downgrades | downgrade |
| `ta_upgrades` | Upgrades | upgrade |
| `ta_earnbefore` | Earnings Before | earnings before market |
| `ta_earnafter` | Earnings After | earnings after market |
| `n_majornews` | Major News | major news |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `111` | Overview — ticker, company, sector, industry, country, market cap, P/E, price, change, volume | overview |
| `121` | Valuation — market cap, P/E, Forward P/E, PEG, P/S, P/B, P/Cash, P/FCF, EPS, dividend yield | valuation |
| `131` | Ownership — market cap, outstanding shares, float, insider/institutional ownership, short float | ownership |
| `141` | Performance — performance periods (day to 10Y), volatility, RSI, SMA | performance |
| `152` | Custom — user-defined columns | custom |
| `161` | Financial — market cap, dividend yield, ROA, ROE, ROI, ratios, margins | financial |
| `171` | Technical — RSI, SMA20/50/200, 52W High/Low, pattern, candlestick, beta, ATR | technical |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ticker` | Ticker A→Z | ticker |
| `-ticker` | Ticker Z→A | |
| `company` | Company name A→Z | company |
| `sector` | Sector | sector |
| `industry` | Industry | industry |
| `country` | Country | country |
| `marketcap` | Market Cap (ascending) | market cap |
| `-marketcap` | Market Cap (descending) | |
| `pe` | P/E (ascending) | PE, PER |
| `-pe` | P/E (descending) | |
| `forwardpe` | Forward P/E (ascending) | forward PE |
| `eps` | EPS (ascending) | EPS |
| `dividendyield` | Dividend Yield (ascending) | dividend |
| `-dividendyield` | Dividend Yield (descending) | |
| `price` | Price (ascending) | price |
| `-price` | Price (descending) | |
| `change` | Change (ascending) | change |
| `-change` | Change (descending) | |
| `volume` | Volume (ascending) | volume |
| `-volume` | Volume (descending) | |
| `recom` | Analyst Recommendation | recommendation |
| `earningsdate` | Earnings Date | earnings date |
...
| `idx_dji` | Dow Jones | Dow |
| `idx_ndx` | NASDAQ 100 | NASDAQ 100 |
| `idx_rut` | Russell 2000 | Russell 2000 |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `sec_basicmaterials` | Basic Materials | basic materials |
| `sec_communicationservices` | Communication Services | communication |
| `sec_consumercyclical` | Consumer Cyclical | consumer cyclical |
| `sec_consumerdefensive` | Consumer Defensive | consumer defensive |
| `sec_energy` | Energy | energy |
| `sec_financial` | Financial | financial |
| `sec_healthcare` | Healthcare | healthcare |
| `sec_industrials` | Industrials | industrials |
| `sec_realestate` | Real Estate | real estate |
| `sec_technology` | Technology | technology |
| `sec_utilities` | Utilities | utilities |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `cap_mega` | Mega ($200B+) | mega cap |
| `cap_large` | Large ($10B–$200B) | large cap |
| `cap_mid` | Mid ($2B–$10B) | mid cap |
| `cap_small` | Small ($300M–$2B) | small cap |
| `cap_micro` | Micro ($50M–$300M) | micro cap |
| `cap_nano` | Nano (under $50M) | nano cap |
| `cap_largeover` | +Large ($10B+) | large+ |
| `cap_midover` | +Mid ($2B+) | mid+ |
| `cap_smallover` | +Small ($300M+) | small+ |
| `cap_microover` | +Micro ($50M+) | micro+ |
| `cap_largeunder` | -Large (under $200B) | large |
| `cap_midunder` | -Mid (under $10B) | mid |
| `cap_smallunder` | -Small (under $2B) | small |
| `cap_microunder` | -Micro (under $300M) | micro |
...
|------|---------|---------------------------|
| `geo_usa` | USA | USA |
| `geo_notusa` | Foreign (ex-USA) | foreign |
| `geo_asia` | Asia | Asia |
| `geo_europe` | Europe | Europe |
| `geo_latinamerica` | Latin America | Latin America |
| `geo_bric` | BRIC | BRIC |
| `geo_china` | China | China |
| `geo_chinahongkong` | China & Hong Kong | |
| `geo_japan` | Japan | Japan |
| `geo_india` | India | India |
| `geo_unitedkingdom` | United Kingdom | UK |
| `geo_canada` | Canada | Canada |
| `geo_germany` | Germany | Germany |
| `geo_france` | France | France |
| `geo_brazil` | Brazil | Brazil |
| `geo_southkorea` | South Korea | South Korea |
| `geo_taiwan` | Taiwan | Taiwan |
| `geo_israel` | Israel | Israel |
| `geo_australia` | Australia | Australia |
| `geo_switzerland` | Switzerland | Switzerland |
| `geo_netherlands` | Netherlands | Netherlands |
| `geo_ireland` | Ireland | Ireland |
| `geo_singapore` | Singapore | Singapore |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ipodate_today` | Today | IPO today |
| `ipodate_yesterday` | Yesterday | |
| `ipodate_prevweek` | In the last week | recent IPO |
...
| `ipodate_more5` | More than 5 years ago | established |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `earningsdate_today` | Today | earnings today |
| `earningsdate_todaybefore` | Today Before Market Open | |
| `earningsdate_todayafter` | Today After Market Close | |
| `earningsdate_tomorrow` | Tomorrow | earnings tomorrow |
| `earningsdate_tomorrowbefore` | Tomorrow Before Market Open | |
| `earningsdate_tomorrowafter` | Tomorrow After Market Close | |
| `earningsdate_yesterday` | Yesterday | |
| `earningsdate_yesterdaybefore` | Yesterday Before Market Open | |
| `earningsdate_yesterdayafter` | Yesterday After Market Close | |
| `earningsdate_thisweek` | This Week | earnings this week |
| `earningsdate_nextweek` | Next Week | earnings next week |
| `earningsdate_prevweek` | Previous Week | |
| `earningsdate_nextdays5` | Next 5 Days | 5 |
| `earningsdate_prevdays5` | Previous 5 Days | 5 |
| `earningsdate_thismonth` | This Month | earnings this month |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_pe_low` | Low (<15) | low PE |
| `fa_pe_profitable` | Profitable (>0) | profitable |
| `fa_pe_high` | High (>50) | high PE |
| `fa_pe_u5` | Under 5 | PE<5 |
| `fa_pe_u10` | Under 10 | PE<10 |
| `fa_pe_u15` | Under 15 | PE<15 |
| `fa_pe_u20` | Under 20 | PE<20 |
...
Special: `fa_pb_low` (Low <1 | Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_evebitda_negative` | Negative (<0) | EV/EBITDA negative |
| `fa_evebitda_low` | Low (<15) | low EV/EBITDA, EV/EBITDA |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_div_none` | None (0%) | no dividend |
| `fa_div_pos` | Positive (>0%) | has dividend |
| `fa_div_high` | High (>5%) | high dividend |
| `fa_div_veryhigh` | Very High (>10%) | very high dividend |
| `fa_div_o1` | Over 1% | 1% |
| `fa_div_o2` | Over 2% | 2% |
| `fa_div_o3` | Over 3% | 3% |
| `fa_div_o4` | Over 4% | 4% |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_divgrowth_1ypos` | 1 Year Positive | 1Y |
| `fa_divgrowth_1yo5` | 1 Year Over 5% | 1Y DG>5% |
| `fa_divgrowth_1yo10` | 1 Year Over 10% | 1Y DG>10% |
| `fa_divgrowth_3ypos` | 3 Years Positive | 3Y |
| `fa_divgrowth_3yo10` | 3 Years Over 10% | 3Y DG>10% |
| `fa_divgrowth_5ypos` | 5 Years Positive | 5Y |
| `fa_divgrowth_5yo10` | 5 Years Over 10% | 5Y DG>10% |
| `fa_divgrowth_cy1` | Growing 1+ Year | 1 |
| `fa_divgrowth_cy3` | Growing 3+ Years | 3 |
| `fa_divgrowth_cy5` | Growing 5+ Years | 5 |
| `fa_divgrowth_cy7` | Growing 7+ Years | 7 |
| `fa_divgrowth_cy9` | Growing 9+ Years | 9 |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_epsqoq_*` | EPS Growth Q/Q | EPS QoQ |
| `fa_epsyoy_*` | EPS Growth This Year | EPS this year |
| `fa_epsyoy1_*` | EPS Growth Next Year | EPS next year |
| `fa_epsyoyttm_*` | EPS Growth TTM | EPS TTM |
| `fa_eps3years_*` | EPS Growth Past 3 Years | 3Y EPS |
| `fa_eps5years_*` | EPS Growth Past 5 Years | 5Y EPS |
| `fa_estltgrowth_*` | EPS Growth Next 5 Years | 5Y EPS |

**Example codes:**

| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_epsqoq_pos` | EPS Q/Q Positive | |
| `fa_epsqoq_o25` | EPS Q/Q Over 25% | |
| `fa_epsyoy_high` | EPS This Year High (>25%) | |
| `fa_epsyoy1_pos` | EPS Next Year Positive | |
| `fa_epsyoyttm_o10` | EPS TTM Over 10% | |
| `fa_eps3years_pos` | EPS Past 3Y Positive | |
| `fa_eps5years_o20` | EPS Past 5Y Over 20% | |
| `fa_estltgrowth_o15` | EPS Next 5Y Over 15% | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_salesqoq_*` | Sales Growth Q/Q | QoQ |
| `fa_salesyoyttm_*` | Sales Growth TTM | TTM |
| `fa_sales3years_*` | Sales Growth Past 3 Years | 3Y |
| `fa_sales5years_*` | Sales Growth Past 5 Years | 5Y |

**Example codes:**

| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_salesqoq_pos` | Sales Q/Q Positive | |
| `fa_salesqoq_o25` | Sales Q/Q Over 25% | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_epsrev_bp` | Both Positive (>0%) | positive surprise |
| `fa_epsrev_bm` | Both Met (0%) | met estimates |
| `fa_epsrev_bn` | Both Negative (<0%) | negative surprise |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_roe_*` | Return on Equity | ROE |
| `fa_roa_*` | Return on Assets | ROA |
| `fa_roi_*` | Return on Invested Capital (ROIC) | ROI, ROIC |

**Example codes:**

| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_roe_o15` | ROE Over 15% | ROE>15% |
| `fa_roe_o30` | ROE Over 30% | ROE>30% |
| `fa_roa_o10` | ROA Over 10% | ROA>10% |
| `fa_roi_o20` | ROIC Over 20% | ROIC>20% |
| `fa_roi_verypos` | ROIC Very Positive (>25%) | ROIC |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_grossmargin_*` | Gross Margin | gross margin |
| `fa_opermargin_*` | Operating Margin | operating margin |
| `fa_netmargin_*` | Net Profit Margin | net margin |

**Example codes:**

| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_grossmargin_o50` | Gross Margin Over 50% | |
| `fa_opermargin_o20` | Operating Margin Over 20% | |
| `fa_netmargin_pos` | Net Margin Positive | |
| `fa_netmargin_o10` | Net Margin Over 10% | |
| `fa_grossmargin_u-10` | Gross Margin Under -10% | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `fa_ltdebteq_u0.5` | LT D/E Under 0.5 | |
| `fa_debteq_low` | Total D/E Low (<0.1) | |
| `fa_curratio_o2` | Current Ratio Over 2 | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_rsi_ob90` | Overbought (90) | extremely overbought |
| `ta_rsi_ob80` | Overbought (80) | overbought |
| `ta_rsi_ob70` | Overbought (70) | overbought |
| `ta_rsi_ob60` | Overbought (60) | |
| `ta_rsi_os40` | Oversold (40) | slightly oversold |
| `ta_rsi_os30` | Oversold (30) | oversold |
| `ta_rsi_os20` | Oversold (20) | deeply oversold |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_sma20_pa` | Price Above SMA20 | above 20MA, 20 |
| `ta_sma20_pb` | Price Below SMA20 | below 20MA, 20 |
| `ta_sma20_pca` | Price Crossed Above SMA20 | break above 20MA, 20 |
| `ta_sma20_pcb` | Price Crossed Below SMA20 | break below 20MA, 20 |
| `ta_sma50_pa` | Price Above SMA50 | above 50MA, 50 |
| `ta_sma50_pb` | Price Below SMA50 | below 50MA, 50 |
| `ta_sma50_pca` | Price Crossed Above SMA50 | break above 50MA, 50 |
| `ta_sma50_pcb` | Price Crossed Below SMA50 | break below 50MA, 50 |
| `ta_sma200_pa` | Price Above SMA200 | above 200MA, 200 |
| `ta_sma200_pb` | Price Below SMA200 | below 200MA, 200 |
| `ta_sma200_pca` | Price Crossed Above SMA200 | break above 200MA |
| `ta_sma200_pcb` | Price Crossed Below SMA200 | break below 200MA |
| `ta_sma200_sa50` | SMA200 Above SMA50 | death cross |
| `ta_sma200_sb50` | SMA200 Below SMA50 | golden cross |
| `ta_sma50_cross200a` | SMA50 Crossed SMA200 Above | golden cross |
| `ta_sma50_cross200b` | SMA50 Crossed SMA200 Below | death cross |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_changeopen_u` | Up from Open | |
| `ta_changeopen_d` | Down from Open | |
...
Examples:
- `ta_highlow52w_10to30-bhx` = 52-week high  10-30% 
- `ta_highlow52w_10to30-alx` = 52-week low  10-30% 
...
|---|---|---|---|
| Pullback buy | `-bhx` | Growth + quality stocks in temporary correction. Uptrend intact. | `ta_highlow52w_10to30-bhx` with `fa_epsqoq_pos` |
| Reversal / deep value | `-alx` | Turnaround or bottom-fishing plays. Higher risk of continued decline. | `ta_highlow52w_10to30-alx` with `fa_pb_u1` |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_highlow52w_nh` | New High | 52-week high, 52 |
| `ta_highlow52w_nl` | New Low | 52-week low, 52 |
| `ta_highlow52w_b0to3h` | 0-3% Below High | near high |
| `ta_highlow52w_b0to5h` | 0-5% Below High | near high |
| `ta_highlow52w_b0to10h` | 0-10% Below High | close to high |
| `ta_highlow52w_b10h` | 10%+ Below High | pullback |
| `ta_highlow52w_b20h` | 20%+ Below High | correction |
| `ta_highlow52w_b30h` | 30%+ Below High | deep correction |
| `ta_highlow52w_b50h` | 50%+ Below High | bear territory |
| `ta_highlow52w_a0to3h` | 0-3% Above Low | near low |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_highlow20d_nh` | 20-Day New High | 20 |
| `ta_highlow20d_nl` | 20-Day New Low | 20 |
| `ta_highlow20d_b0to5h` | 0-5% Below 20D High | 20 |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_highlow50d_nh` | 50-Day New High | 50 |
| `ta_highlow50d_nl` | 50-Day New Low | 50 |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_alltime_nh` | All-Time High | all-time high |
| `ta_alltime_nl` | All-Time Low | all-time low |
| `ta_alltime_b0to3h` | 0-3% Below ATH | ATH |
| `ta_alltime_b0to5h` | 0-5% Below ATH | ATH |
| `ta_alltime_b10h` | 10%+ Below ATH | ATH10% |
| `ta_alltime_b20h` | 20%+ Below ATH | ATH20% |
| `ta_alltime_b50h` | 50%+ Below ATH | ATH |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_perf_dup` | Today Up | today up |
| `ta_perf_ddown` | Today Down | today down |
| `ta_perf_d5o` | Today +5% | big up today |
| `ta_perf_d5u` | Today -5% | big down today |
| `ta_perf_1wup` | Week Up | week up |
| `ta_perf_1wdown` | Week Down | week down |
| `ta_perf_4wup` | Month Up | month up |
| `ta_perf_4wdown` | Month Down | month down |
| `ta_perf_13wup` | Quarter Up | quarter up |
| `ta_perf_13wdown` | Quarter Down | quarter down |
| `ta_perf_26wup` | Half Year Up | half up |
| `ta_perf_52wup` | Year Up | year up |
| `ta_perf_52wdown` | Year Down | year down |
| `ta_perf_ytdup` | YTD Up | YTD up |
| `ta_perf_ytddown` | YTD Down | YTD down |
| `ta_perf_3yup` | 3 Years Up | 3Y up |
| `ta_perf_5yup` | 5 Years Up | 5Y up |
| `ta_perf_10yup` | 10 Years Up | 10Y up |
| `ta_perf_52w100o` | Year +100% | 2 |
| `ta_perf_52w50u` | Year -50% | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_gap_u` | Gap Up | gap up |
| `ta_gap_d` | Gap Down | gap down |
| `ta_gap_u0` | Gap Up 0%+ | |
| `ta_gap_u3` | Gap Up 3%+ | |
...
| `ta_beta_u0.5` | Beta Under 0.5 | low beta |
| `ta_beta_u1` | Beta Under 1 | below market |
| `ta_beta_o1` | Beta Over 1 | above market |
| `ta_beta_o1.5` | Beta Over 1.5 | high beta |
...
| `ta_pattern_channeldown` | Channel Down | falling channel |
| `ta_pattern_channeldown2` | Channel Down (Strong) | |
| `ta_pattern_channelup` | Channel Up | rising channel |
| `ta_pattern_channelup2` | Channel Up (Strong) | |
| `ta_pattern_doublebottom` | Double Bottom | double bottom |
| `ta_pattern_doubletop` | Double Top | double top |
| `ta_pattern_headandshoulders` | Head & Shoulders | H&S |
| `ta_pattern_headandshouldersinv` | Head & Shoulders Inverse | inverse H&S |
| `ta_pattern_horizontal` | Horizontal S/R | horizontal channel |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ta_candlestick_d` | Doji | doji |
| `ta_candlestick_dd` | Dragonfly Doji | dragonfly doji |
| `ta_candlestick_gd` | Gravestone Doji | gravestone doji |
| `ta_candlestick_h` | Hammer | hammer |
| `ta_candlestick_ih` | Inverted Hammer | inverted hammer |
| `ta_candlestick_lls` | Long Lower Shadow | long lower shadow |
| `ta_candlestick_lus` | Long Upper Shadow | long upper shadow |
| `ta_candlestick_mb` | Marubozu Black | marubozu black |
| `ta_candlestick_mw` | Marubozu White | marubozu white |
...
| `sh_avgvol_o200` | Over 200K | min volume |
| `sh_avgvol_o500` | Over 500K | |
| `sh_avgvol_o1000` | Over 1M | high volume |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `sh_price_u1` | Under $1 | penny stock |
| `sh_price_u5` | Under $5 | low price |
...
| `sh_price_o100` | Over $100 | expensive |
| `sh_price_5to50` | $5 to $50 | |
| `sh_price_10to50` | $10 to $50 | |
...
| `sh_float_u5` | Under 5M | low float |
...
| `sh_short_high` | High (>20%) | heavily shorted |
| `sh_short_u5` | Under 5% | |
| `sh_short_u10` | Under 10% | |
| `sh_short_o5` | Over 5% | some short interest |
| `sh_short_o10` | Over 10% | high short |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `sh_opt_option` | Optionable | optionable |
| `sh_opt_short` | Shortable | shortable |
| `sh_opt_notoption` | Not Optionable | |
| `sh_opt_notshort` | Not Shortable | |
| `sh_opt_optionshort` | Optionable and Shortable | |
...
| `sh_insiderown_o10` | Over 10% | 10%+ |
| `sh_insiderown_o20` | Over 20% | |
| `sh_insiderown_o30` | Over 30% | |
| `sh_insiderown_o50` | Over 50% | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `sh_insidertrans_pos` | Positive (>0%) | insider buying |
| `sh_insidertrans_neg` | Negative (<0%) | insider selling |
| `sh_insidertrans_verypos` | Very Positive (>20%) | heavy insider buying |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `sh_insttrans_pos` | Positive (>0%) | institutional buying |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `an_recom_strongbuy` | Strong Buy (1) | strong buy |
| `an_recom_buybetter` | Buy or better (1-2) | buy |
| `an_recom_buy` | Buy (2) | |
| `an_recom_holdbetter` | Hold or better (1-3) | hold |
| `an_recom_hold` | Hold (3) | |
| `an_recom_holdworse` | Hold or worse (3-5) | |
| `an_recom_sell` | Sell (4) | |
| `an_recom_sellworse` | Sell or worse (4-5) | sell |
| `an_recom_strongsell` | Strong Sell (5) | strong sell |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `targetprice_above` | Above Price | target above |
| `targetprice_below` | Below Price | target below |
| `targetprice_a5` | 5% Above Price | |
| `targetprice_a10` | 10% Above Price | |
| `targetprice_a20` | 20% Above Price | |
| `targetprice_a30` | 30% Above Price | |
| `targetprice_a40` | 40% Above Price | |
| `targetprice_a50` | 50% Above Price | |
...
| `targetprice_b50` | 50% Below Price | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `news_date_today` | Today | news today |
...
| `news_date_prevminutes5` | In the last 5 minutes | 5 |
| `news_date_prevminutes30` | In the last 30 minutes | 30 |
| `news_date_prevhours1` | In the last hour | 1 |
| `news_date_prevhours24` | In the last 24 hours | 24 |
| `news_date_prevdays7` | In the last 7 days | 1 |
| `news_date_prevmonth` | In the last month | 1 |
...
| `autonomoussystems` | Autonomous Systems | autonomous |
| `bigdata` | Big Data | big data |
| `biometrics` | Biometrics | |
| `cloudcomputing` | Cloud Computing | cloud |
...
| `cryptoblockchain` | Crypto & Blockchain | crypto |
...
| `electricvehicles` | Electric Vehicles | EV |
| `energyrenewable` | Energy - Renewable | renewable |
| `energytraditional` | Energy - Traditional | |
| `environmentalsustainability` | Environmental Sustainability | |
| `fintech` | FinTech | fintech |
| `hardware` | Hardware | hardware |
| `healthcarebiotech` | Healthcare & Biotech | biotech |
...
| `realestatereits` | Real Estate & REITs | REITs |
| `robotics` | Robotics | robotics |
| `semiconductors` | Semiconductors | semiconductors |
| `smarthome` | Smart Home | |
| `socialmedia` | Social Media | |
| `software` | Software | software |
| `spacetech` | Space Tech | space |
| `telecommunications` | Telecommunications | |
| `transportationlogistics` | Transportation & Logistics | |
| `virtualaugmentedreality` | Virtual & Augmented Reality | VR, AR |
| `wearables` | Wearables | |
...
| Code | Meaning | Natural Language Keywords |
|------|---------|---------------------------|
| `ind_stocksonly` | Stocks only (ex-Funds) | funds |
...
| `ind_reitindustrial` | REIT - Industrial | REIT |
| `ind_reitresidential` | REIT - Residential | REIT |
...
### AI Cloud + Compute Sub-themes (AI＆)
