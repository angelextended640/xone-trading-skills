...
condition:          5-min ORL breaks down on volume ≥ 1.2x
...
condition:          Break of low of the first red 5-min candle after the open
...
condition:          After the first crack, a VWAP retest is rejected by a 5-min close + lower-high gets broken
